...
exten => 2,1,Goto(music_playlists_2'.$device.',select,1)
exten => 2,2,Hangup();

exten => 3,1,Goto(music_playlists_3'.$device.',select,1)
exten => 3,2,Hangup();

exten => 4,1,Goto(music_playlists_4'.$device.',select,1)
exten => 4,2,Hangup();

exten => 5,1,Goto(music_playlists_5'.$device.',select,1)
exten => 5,2,Hangup();

exten => 6,1,Goto(music_playlists_6'.$device.',select,1)
exten => 6,2,Hangup();

exten => 7,1,Goto(music_playlists_7'.$device.',select,1)
exten => 7,2,Hangup();

exten => 8,1,Goto(music_playlists_8'.$device.',select,1)
exten => 8,2,Hangup();

exten => 9,1,Goto(music_playlists_9'.$device.',select,1)
exten => 9,2,Hangup();
...
foreach($aPlaylists as $sPlaylist) {
   ...
   if ($sPlaylist != "" && strpos($sPlaylist, "mpddir_") !== 0) { 
...
exten => '.$i.',3,System(/opt/sascha/snapcast/switch_'.$device.'.php mpd)
